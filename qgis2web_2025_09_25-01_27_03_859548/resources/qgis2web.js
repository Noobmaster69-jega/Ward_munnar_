...
map.getView().fit([8553958.978591, 1117979.583598, 8606178.256391, 1152040.242063], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Munnar_ward</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (652 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Munnar is a picturesque hill station in Kerala, India, nestled in the Western Ghats at an altitude of 1,600 meters. It is renowned for its breathtaking tea plantations, misty valleys, and diverse biodiversity, including the Neelakurinji flower, which blooms once every twelve years. The name "Munnar" comes from the Malayalam word for "three rivers," referring to the confluence of the Muthirapuzha, Nallathanni, and Kundala rivers at the town\'s location. This former summer resort for British rulers has grown into a popular tourist destination, attracting visitors with its scenic beauty, cool climate, waterfalls, and the highest peak in South India';
            }
